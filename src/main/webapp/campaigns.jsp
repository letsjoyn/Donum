...
<%
    ...
    List<Campaign> campaigns = cDao.getAllCampaigns();
                        ...
                        <div class="card-header">
                            <div style="display:flex;justify-content:space-between;align-items:center;">
                                <div>
                                    ...
                                    <span class="org-name"><i class="fas fa-building"></i> ${fn:escapeXml(c.orgName)}</span>
                                </div>
                                <span class="badge badge-${fn:toLowerCase(c.status)}">${c.status}</span>
                            </div>
                        </div>
                        <div class="card-body">
                            <p style="font-size:0.85rem;color:var(--text-dim);margin-bottom:1rem;min-height:40px;">
                            ...
                            <div style="display:flex;justify-content:space-between;font-size:0.8rem;color:var(--text-muted);margin-bottom:0.5rem;">
                                <span><i class="fas fa-calendar-alt"></i>
                                    ...
                                    <c:if test="${c.endDate != null}"> - <fmt:formatDate value="${c.endDate}" pattern="dd MMM yyyy"/></c:if>
                                </span>
                            </div>

                            <div class="amounts">
                                <span class="raised">&#8377;<fmt:formatNumber value="${c.raisedAmount}" maxFractionDigits="0"/> raised</span>
                            ...
                            <div style="text-align:right;font-size:0.75rem;color:var(--text-dim);margin-top:0.3rem;">
